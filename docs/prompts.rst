...
command_line_interface
    Whether to create a console script using Typer. Console script entry point will match the project_slug. Options: ['Typer', 'Argparse', 'No command-line interface']
